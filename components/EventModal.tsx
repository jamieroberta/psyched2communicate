...
import { Event, urlFor, isImage, isPDF, isWord, isFile } from '@/lib/sanity'
            ...
            >
              <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                  ...
                  <div className="relative">
                    {isImage(event.media) ? (
                      <div className="relative h-64 w-full cursor-pointer group">
                        <a
                          href={urlFor(event.media[0]).width(1200).height(800).url()}
                          target="_blank"
                ...
                <div className="p-6 space-y-6">
                  ...
                  {!(event.media && event.media.length > 0 && isFile(event.media)) && event.description && (
                    <div>
                  ...
                  {/* Show compact content for file events */}
                  {event.media && event.media.length > 0 && isFile(event.media) && event.description && (
                    <div>
