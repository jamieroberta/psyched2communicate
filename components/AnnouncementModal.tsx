            ...
            >
              <Dialog.Panel className="w-full max-w-3xl transform overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all">
                ...
                {announcement.media && announcement.media.length > 0 && (() => {
                  const mediaItem = announcement.media[0]
                      ...
                      <div className="relative h-64 w-full cursor-pointer group">
                        ...
                        >
                          <Image
                            ...
                            alt={mediaItem.alt || announcement.title}
                            fill
                ...
                <div className="p-6 space-y-6">
                  ...
                  {!(announcement.media && announcement.media.length > 0 && announcement.media[0]._type === 'file') && (
                    <>
                  ...
                  {/* Show compact content for PDF announcements */}
                  {announcement.media && announcement.media.length > 0 && announcement.media[0]._type === 'file' && announcement.excerpt && (
                    <div>
